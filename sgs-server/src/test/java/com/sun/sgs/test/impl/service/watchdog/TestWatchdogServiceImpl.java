...
public class TestWatchdogServiceImpl extends Assert {
    ...
    @IntegrationTest
    @Test
    public void testRecoveryWithBackupFailureDuringRecovery()
            throws Exception {
        Map<Long, WatchdogAndData> watchdogs =
                new ConcurrentHashMap<Long, WatchdogAndData>();
        List<Long> shutdownIds = new ArrayList<Long>();
    ...
    @IntegrationTest
    @Test
    public void testRecoveryWithDelayedBackupAssignment()
            throws Exception {
        List<Long> shutdownIds = new ArrayList<Long>();
    ...
    @IntegrationTest
    @Test
    public void testRecoveryAfterAllNodesAndServerCrash()
            throws Exception {
        Map<Long, WatchdogAndData> watchdogs =
                new ConcurrentHashMap<Long, WatchdogAndData>();
        List<Long> shutdownIds = new ArrayList<Long>();
