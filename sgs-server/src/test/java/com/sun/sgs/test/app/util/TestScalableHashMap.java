...
public class TestScalableHashMap extends Assert {
    ...
    @Test
    public void testPutAndRemoveOnNoMergeTreeWithNoCollapse()
            throws Exception {
        txnScheduler.runTask(
                new TestAbstractKernelRunnable() {
                    public void run() throws Exception {
    ...
    @Test
    public void testPutAndRemoveOnNoMergeTreeWithCollapse()
            throws Exception {
        txnScheduler.runTask(
                new TestAbstractKernelRunnable() {
                    public void run() throws Exception {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testConcurrentIteratorWithReplacements()
            throws Exception {
        txnScheduler.runTask(
                new TestAbstractKernelRunnable() {
                    public void run() throws Exception {
