...
public class TestExtJarGraph {
    ...
    @Test
    public void testJarNoProperties() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
    ...
    @Test
    public void testJarDuplicateProperties() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
        graph.addJarFile(new JarFile(JAR_A));
    ...
    @Test
    public void testJarMergedServicesEmptyManager() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
    ...
    @Test
    public void testJarMergedServices() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
    ...
    @Test
    public void testMultipleJarNoDependency() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
        graph.addJarFile(new JarFile(JAR_A));
    ...
    @Test
    public void testValidDepdency() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
        graph.addJarFile(new JarFile(JAR_A));
    ...
    @Test
    public void testValidMultipleDepdency() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
        graph.addJarFile(new JarFile(JAR_A));
    ...
    @Test
    public void testValidDepdencyMultipleRoots() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
        graph.addJarFile(new JarFile(JAR_A));
        graph.addJarFile(new JarFile(JAR_B_DEPENDS_ON_A));
    ...
    @Test
    public void testDeeperDependency() throws Exception {
        ExtJarGraph graph = new ExtJarGraph();
        graph.addJarFile(new JarFile(JAR_A));
        graph.addJarFile(new JarFile(JAR_D_DEPENDS_ON_A_AND_B));
